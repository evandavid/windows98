...
function HeaderButtons({
  ...
  const buttonElements = {
    minimize: (
      <button key="minimize" aria-label="Minimize" onMouseUp={onMinimize} />
    ),
    maximize: (
      <button
        key="maximize"
    ...
    close: <button key="button" aria-label="Close" onMouseUp={onClose} />,
  };

  return (
    <div className={classNames(className, 'title-bar-controls')}>
      {buttons ? (
